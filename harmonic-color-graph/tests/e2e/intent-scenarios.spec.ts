...
// Run against a deployed web+API pair with HCG_LIVE_RECOMMEND=1. Local runs
// without an active corpus keep these tests skipped; the backend HTTP snapshot
// tests cover the scoring path offline.
